	...
	<div class="entry-content">
		<div class="row">
			...
			<p class="f20">y8x soll ein Unternehmen werden, das eine Platform mit Open Source Baupläne für Maschinen und Objekte 
				...
				<p class="f20">Nutzer_innen können Bauplänen hochladen, runterladen, online bewerten und verbessern, 
		...
		<hr>
		<h2 id="Produkte">Produkte (beta)</h2>
		<div class="row mt-lg">
			<div class="col-md-12 mb-lg">
				<p>Das Ziel ist es eine Platform zu schaffen, auf der Baupläne für viele verschiedene Dinge angesehen werden,
					und die zugehörigen Bausätze direkt bestellt werden können. Jede_r soll Pläne hochladen können, die wir überprüfen, nachbauen
					und falls geeignet zu unserem Sortiment hinzufügen. Bis die Infrastruktur dazu geschaffen wurde stellen wir euch
					drei Produkte vor, an deren Plänen wir gerade arbeiten und deren Prototypen wir bereits testen.
			</div>
			<div class="col-md-4">
				<img src="http://www.radfahrlust.de/images/lastenrad.jpg" class="auto">
				<h3 class="mt-lg">Lastenrad</h3>
